...
import (
	...
	ctrl_controller_9e52fc52 "github.com/star-integrations/project-boilerplate/back/server/mock/controller"
...
func addRoutes(e *echo.Echo, p *props.ControllerProps) {
	...
	{
		ctrl := ctrl_controller_9e52fc52.NewGetHealthCheckController(p)
